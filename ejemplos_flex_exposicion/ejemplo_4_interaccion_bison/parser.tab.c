...
#line 60 "parser.y"
        {
      cout << "bison found an int_: " << (yyvsp[0].ival) << endl;
    }
...
#line 63 "parser.y"
          {
      cout << "bison found a float_: " << (yyvsp[0].fval) << endl;
    }
...
#line 66 "parser.y"
           {
      cout << "bison found a string_: " << (yyvsp[0].sval) << endl; free((yyvsp[0].sval));
    }
